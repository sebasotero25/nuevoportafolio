  ...
  return (
    <div className="App">
      <div className="pagina-uno">
        ...
        <img
          className="se"
          src="https://cdn.discordapp.com/attachments/968368069514772502/997768504713429062/boniMesa_de_trabajo_8.webp"
          alt=""
        />
      </div>
      <div className="second-container">
        ...
        <span className="margin-left">
          <img
            ...
            src="https://cdn.discordapp.com/attachments/968368069514772502/997768325243359323/boniMesa_de_trabajo_4.webp"
            alt=""
          />
        </span>
      </div>
      <div className="pagina-3 ">
        <span className="margin-left margin-top2 position-rel ">
          <img
            className="estudios-width "
            src="https://cdn.discordapp.com/attachments/968368069514772502/998075183254474822/boniMesa_de_trabajo_6.webp"
            alt=""
          />
        ...
        <span className="min-100 margin-top2 margin-left abilities ">
        <img
            className="img2"
            src="https://cdn.discordapp.com/attachments/968368069514772502/998075849528049704/boniMesa_de_trabajo_5_2.webp"
            alt=""
          />
